...
"Nikolas Tesla: Ela não tem um alcance tão alto de distribuição, saindo mais caro com o projeto com muita energia perdida podendo causando até incêndios.",
...
"Nikolas Tesla: Mas o que seria esse 'banheiro'?",
"Vinicius: É um local que preciso ir com urgência...",
"Nikolas Tesla: Que rapaz estranho, pois bem, então eu me despeço.",
